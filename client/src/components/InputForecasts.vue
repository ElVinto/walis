        ...
        <div id="" class="col-sm-9">
          <div v-if="$store.getters.getSelectedLocName && $store.getters.getSelectedStartingDate" >
            ...
            <div v-if= "displayLines">
              ...
              <ForecastsLineChart v-bind:forecastParams="fInputParams_2"></ForecastsLineChart> 
            ...
            <div v-if= "displayEnvelop">
              ...
              <ForecastEnvelopChart v-bind:forecastParams="fInputParams_4"></ForecastEnvelopChart> 
            ...
            <div v-if= "displayHistogram">
              ...
              <CandleStickHighChart v-bind:forecastParams="fInputParams_4"></CandleStickHighChart> 
